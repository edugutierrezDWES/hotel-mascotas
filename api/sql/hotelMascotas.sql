...
/*******************************************************************************
   Create Foreign Keys
********************************************************************************/
ALTER TABLE reserva ADD CONSTRAINT FK_ReservaHabitacion FOREIGN KEY (id_hab) REFERENCES habitacion(id_hab) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE reserva ADD CONSTRAINT FK_ReservaUsuario FOREIGN KEY (id_usuario) REFERENCES usuario(id_usuario) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE mascota ADD CONSTRAINT FK_MascotaUsuario FOREIGN KEY (id_usuario) REFERENCES usuario(id_usuario);

ALTER TABLE reserva_mascota ADD CONSTRAINT FK_ReservaMascotaID FOREIGN KEY (id_mascota) REFERENCES mascota(id_mascota) ON DELETE NO ACTION ON UPDATE NO ACTION;
